...
if mensagem_inicial == 1:
    valor_deposito = float(input(f"Seu saldo atual é de R${saldo_inicial:.2f}!\nQual valor deseja depositar?\nR$"))
    if valor_deposito >0:
    ...
    if outras_operacoes == 1:
            valor_deposito2=float(input(f"Seu saldo atual é de R${saldo_deposito:.2f}!\nQual valor deseja depositar?\nR$"))
        ...
        valor_saque2 = float(input(f"Seu saldo atual é de R${saldo_deposito:.2f}!\nQual valor deseja sacar?\nR$"))
    ...
    valor_saque = float(input(f"Seu saldo atual é de R${saldo_inicial:.2f}!\nQual valor deseja sacar?\nR$")) 
    if valor_saque > saldo_inicial:
        ...
        outras_operacoes = int(input("[1]- Depósito [2]- Saque [3]- Sair\n"))
        if outras_operacoes == 1:
            valor_deposito3=float(input(f"Seu saldo atual é de R${saldo_saque:.2f}!\nQual valor deseja depositar?\nR$"))
            if valor_deposito3 >0:
                print(f"Depósito realizado com sucesso! Seu saldo atual é de {saldo_saque+valor_deposito3:.2f}\nObrigado por utilizar nossos serviços.")
        elif outras_operacoes == 2:
            valor_saque3 = float(input(f"Seu saldo atual é de R${saldo_saque:.2f}!\nQual valor deseja sacar?\nR$"))
         ...
         print(f"Seu saldo atual é de R${saldo_saque:.2f}\nObrigado por utilizar nossos serviços.")
    #emprestimo
elif mensagem_inicial == 3:
    valor_emprestimo = float(input(f"Seu saldo atual é de R${saldo_inicial:.2f}!\nQual valor do empréstimo?\nR$"))
    ...
    outras_operacoes = int(input("[1]- Depósito [2]- Saque [3]- Sair\n"))
    if outras_operacoes == 1:
        valor_deposito2=float(input(f"Seu saldo atual é de R${saldo_emprestimo:.2f}!\nQual valor deseja depositar?\nR$"))
        if valor_deposito2 >0:
            print(f"Depósito realizado com sucesso! Seu saldo atual é de {saldo_emprestimo+valor_deposito2:.2f}\nObrigado por utilizar nossos serviços.")
    elif outras_operacoes == 2:
        valor_saque2 = float(input(f"Seu saldo atual é de R${saldo_emprestimo:.2f}!\nQual valor deseja sacar?\nR$")) 
        if valor_saque2 > saldo_emprestimo:
         ...
         print(f"Seu saldo atual é de R${saldo_emprestimo:.2f}\nObrigado por utilizar nossos serviços.")
else:
